...
def main2(env):
    ...
    # print(dir(openpype.pipeline))
    boot()
    # print(OpenPypeVersion)
    # import openpype.pype_commands
    # openpype.pype_commands.PypeCommands.publish("/home/shared/opt/OpenPype/openpype/settings/defaults/project_settings/standalonepublisher.json")
    ...
    project_name = "cse_test_048"
    project = get_project(project_name)
    asset = get_asset_by_name(project_name, "CSE101_BG_EXT_BoaBranch")

    import openpype.hosts.traypublisher.api.pipeline as traypipe
    ...
    context = tp.get_context_data()
    import openpype.hosts.traypublisher.plugins.create.create_editorial as create_editorial
    # create_editorial.EditorialPlateInstanceCreator()
    import openpype.hosts.standalonepublisher.plugins.publish.collect_texture as ct
    tex = ct.CollectTextures()
    tex.process(context)
...
#     fields=None
# ):
    openpype.pipeline.context_tools.change_current_context(asset, "Concept", template_key=None)
